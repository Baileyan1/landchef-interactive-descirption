...
$(document).ready(function() {
    $(".philosophie").click(function(){
        $(".rechteSeite h4").text("Philosophie");
    ...
    $(".partner").click(function(){
        $(".rechteSeite h4").text("Partnerschaft");
    ...
    $(".ui").click(function(){
        $(".rechteSeite h4").text("Nutzererlebnis");
    ...
    $(".abo").click(function(){
        $(".rechteSeite h4").text("Abo-Modell");
    ...
    $(".service").click(function(){
        $(".rechteSeite h4").text("Service & Funktionalität");
